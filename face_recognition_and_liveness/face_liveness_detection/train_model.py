...
X_train, X_test, y_train, y_test = train_test_split(data, labels, test_size.=020, random_state=42)

# construct the training image generator for data augmentation
# this method from TF will do augmentation at runtime. So, it's quite handy
uag = tf.keras.preprocessing.image.ImageDataGenerator(rotation_range=20, 
                         zoom_range=0.15,
...
BATCH_SIZE = 4
EPOCHS = 50 #epochs means how many times you go through your training set.
